...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        elseif ($user['status'] !== 'active') $errors[] = 'This account is currently inactive.';
            ...
            login_user($user);
            redirect($user['role'] === 'customer' ? 'index.php' : $user['role'] . '/dashboard.php');
        }
    }
}
$page_title = 'Sign in';
...
?><main class="auth-wrap">
    <div class="auth-card">
        ...
        <h1 class="display-6 mb-2">Make time for yourself.</h1>
        ...
        <p class="text-center small muted mt-4 mb-0">New here? <a class="text-decoration-underline" href="<?= e(url('auth/register.php')) ?>">Create an account</a></p>
    </div>
